...
INFLUXDB_TOKEN = "dG4MQQl2c27R23iekfEFzASOG9sYW55uvUL1LYWDLiOuiXF_Fm0tOqb8MCvZIk7_1MYZODNLHccCZTrAONLovA=="  # Replace with your InfluxDB token
INFLUXDB_ORG = "ntu"      # Replace with your InfluxDB organization name
INFLUXDB_BUCKET = "iot-lab13"  # InfluxDB bucket name

# MQTT setup
MQTT_BROKER = "192.168.116.210"  # ESP32's MQTT broker address
